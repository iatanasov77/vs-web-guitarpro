...
--
-- Host: localhost
-- Generation Time: May 08, 2022 at 09:36 AM
...
(1, 1, 'NOT_IMPLEMETED', '9baea75cce1cfe191ee9b4b98eedbc12', '$2y$13$UADGq2VCSJDGbKJ82uX1kOjDcmdAk.stixNvpgVDyWiPZsR8QdinG', 'a:1:{i:0;s:16:\"ROLE_SUPER_ADMIN\";}', 'admin', 'admin@wgp-upgrade.lh', 'en_US', '2022-05-04 18:35:12', NULL, NULL, 1, 1),
(2, 2, 'NOT_IMPLEMETED', 'd10545c6a28fdba2511e1eb32d56c613', '$2y$13$GvIC1aPJevV7E/Af.n/ASO4fJ.76I8A.heYZt4/M06e.tRk6mKSpi', 'a:1:{i:0;s:22:\"ROLE_APPLICATION_ADMIN\";}', 'appadmin', 'appadmin@wgp-upgrade.lh', 'en_US', NULL, NULL, NULL, 1, 1);
...
INSERT INTO `WGP_Tablatures` (`id`, `user_id`, `artist`, `song`, `tablature_file_id`) VALUES
(3, 1, 'Slayer', 'South Of Heaven', 1);
...
(1, 3, 'application/octet-stream', '4d/31/e57f35b452dda840d89fa152b8a7.bin', 'SoundOfHeaven.gp3');
COMMIT;
