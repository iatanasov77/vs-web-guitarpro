 ...
 */
final class Version20220804065621 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WGP_TablatureCategories DROP FOREIGN KEY FK_EF9842F4DE13F470');
        $this->addSql('ALTER TABLE WGP_TablatureCategories ADD CONSTRAINT FK_EF9842F4DE13F470 FOREIGN KEY (taxon_id) REFERENCES VSAPP_Taxons (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
