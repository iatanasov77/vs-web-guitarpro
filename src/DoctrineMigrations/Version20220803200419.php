 ...
 */
final class Version20220803200419 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WGP_Tablatures_Categories DROP FOREIGN KEY FK_97CB9EDBEBE5F332');
        $this->addSql('ALTER TABLE WGP_Tablatures_Categories DROP FOREIGN KEY FK_97CB9EDB12469DE2');
        $this->addSql('ALTER TABLE WGP_Tablatures_Categories ADD CONSTRAINT FK_97CB9EDBEBE5F332 FOREIGN KEY (tablature_id) REFERENCES WGP_Tablatures (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE WGP_Tablatures_Categories ADD CONSTRAINT FK_97CB9EDB12469DE2 FOREIGN KEY (category_id) REFERENCES WGP_TablatureCategories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
